...
- **Pin:** copy `HIG-QUICK.md` and `VERSION` into `docs/hig/`, use the [tagged URL](https://github.com/frozonfreak/hig/blob/v1.12.5/HIG-QUICK.md), or run the installer in [packages/install](./packages/install/).
