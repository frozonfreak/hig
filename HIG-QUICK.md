...
**Layer 1** · ~5 minutes · **Version:** v1.12.3

**Pin this file — that is the whole onboarding path.** You do not need the rest of the repository to start.

- **Pin:** copy `HIG-QUICK.md` and `VERSION` into `docs/hig/`, use the [tagged URL](https://github.com/frozonfreak/hig/blob/v1.12.3/HIG-QUICK.md), or run the installer in [packages/install](./packages/install/).
