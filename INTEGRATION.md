...
**Current contract:** [HIG.md](./HIG.md) v1.10.1 (see [VERSION](./VERSION)). **Profiles:** [PROFILES.md](./PROFILES.md) · **Adopters:** [ADOPTERS.md](./ADOPTERS.md).
...
| **Raw URL pin** | Agent rules link to tagged release files (e.g. `.../blob/v1.10.1/HIG-LITE.md`) |
...
Pinned contract: The Web HIG v1.10.1
