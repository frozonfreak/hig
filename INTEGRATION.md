...
**Current contract:** [HIG.md](./HIG.md) v1.12.4 (see [VERSION](./VERSION)). **Profiles:** [PROFILES.md](./PROFILES.md) · **Adopters:** [ADOPTERS.md](./ADOPTERS.md).
...
| **Raw URL pin** | Agent rules link to tagged release files (e.g. `.../blob/v1.12.4/HIG-LITE.md`) |
