...
See the monorepo root for the complete 98-rule Quick Reference and [rules/quick-rule-map.yaml](https://github.com/frozonfreak/hig/blob/main/rules/quick-rule-map.yaml).
