...
| [../rules/](../rules/) | `docs/hig/rules/` (INDEX.md, manifest.yaml, archetypes/, topic modules) |
| [../framework/](../framework/) | `docs/hig/framework/` (React, Next, Vue, Nuxt, Astro) |
| [agent-rules/cursor-hig.mdc](./agent-rules/cursor-hig.mdc) | `.cursor/rules/hig.mdc` |
| [agent-rules/CLAUDE-hig.md](./agent-rules/CLAUDE-hig.md) | `CLAUDE.md` (merge) |
