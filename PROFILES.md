...
Example: *"Acme App pins Web HIG v1.12.4 Practical profile for Application and Auth archetypes."*
...
> This project pins **The Web HIG v1.12.4** · **Practical** profile · **Application** and **Auth** archetypes. Scope: `docs/hig-scope.md` (product repo path).
