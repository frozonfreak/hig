...
| --- | --- | --- | --- |
| [HIG documentation site](https://frozonfreak.github.io/hig/) | v1.11.1 · Full | Static docs | Hosts the standard’s public documentation |
| [Live demo (Aruvi Flow)](https://hig.aruviflow.com/) | v1.11.1 · Practical | Web app | Demonstrates archetypes, surfaces, states, and HIG-aligned UX patterns |
| [This repository](https://github.com/frozonfreak/hig) | v1.11.1 · Full | Markdown, CI | Source of truth; `examples/agent-rules/` consumed by downstream repos |
...
```markdown
| [Project name](https://example.com) | v1.11.1 · Practical | Application, Auth | Cursor rule + `docs/hig-scope.md` | [repo](https://github.com/example/project) |
```
