...
## Human Interface Guidelines for the Web

The open-source, vendor-neutral standard for building modern web interfaces.

Modern Web HIG defines how web interfaces should:
...
Modern Web HIG fills that gap — a shared contract for how interfaces should behave, recover, and adapt, whether built by hand or generated by AI.
